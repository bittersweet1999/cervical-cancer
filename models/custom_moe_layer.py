    ...
    * `d_hidden` is the dimension of the MLP layer.
    ...
    def __init__(
        ...
        **kwargs
        ...
        # print('multi_gate',self.multi_gate,gate)
        if gate == NoisyGate:
            if self.multi_gate:
    ...
    def forward(self, input_feature: torch.Tensor, gate_inp=None, task_id = None, task_specific_feature = None, sem=None):
        ...
        # for i in task_token_out:
        #     print(i.size(),out_feature.size())
        # out_feature = torch.cat((*task_token_out,out_feature),dim=1)
        # print(out_feature.shape,original_shape,'sssssssss')
        ...
        # #         output = self.forward_moe(gate_inp=gate_inp, moe_inp=inp, task_id=i, sem=sem)
        # print(gate_inp.size(),inp.size())
        # output = self.forward_moe(gate_inp=gate_inp, moe_inp=inp, task_id=task_id, sem=sem)
        # # print(out.size(),'wwwwddd')
    ...
    def forward_moe(self, gate_inp, moe_inp, task_id=None, sem=None):
        ...
        # print(task_id,self.multi_gate,'ppppp')
